<?php
	...
	function bsc_enqueue_styles_scripts() {
		...
		//wp_enqueue_script( 'jquery', '//code.jquery.com/jquery-3.2.1.slim.min.js'); //Enqeueue Jquery
		wp_enqueue_script ('jquery'); 
		wp_enqueue_script( 'popper', '//cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js', $deps, $ver, true); //Popper JS 
		wp_enqueue_script( 'bootstrap.min', '//maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css', $deps, $ver, true); //Bootstrap JS
	} 
